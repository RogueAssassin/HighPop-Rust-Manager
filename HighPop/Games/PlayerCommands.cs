...
internal static class RustRcon
{
    ...
    public static string? Kick(string p)                  => $"kick \"{Clean(p)}\" \"Kicked by admin\"";
    public static string? Kick(string p, string reason)   => $"kick \"{Clean(p)}\" \"{Clean(reason)}\"";
    public static string? Ban(string p)                   => $"ban \"{Clean(p)}\" \"Banned by admin\"";
    public static string? Ban(string p, string reason)    => $"ban \"{Clean(p)}\" \"{Clean(reason)}\"";
    public static string? Unban(string p)                 => $"unban \"{Clean(p)}\"";
    public static string? Players()                       => "playerlist";
    public static string? Broadcast(string msg)           => $"say \"{Clean(msg)}\"";
