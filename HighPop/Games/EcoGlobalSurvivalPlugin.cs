...
public class EcoGlobalSurvivalPlugin : GamePluginBase
{
    ...
    public override string Description     => "Multiplayer survival game about building a civilization without destroying the ecosystem — most server settings (public/private, password, world name) are managed through Eco's own web admin panel, not HighPop's config fields";
