...
public static class PluginExporterService
{
    public static string GenerateSource(IGamePlugin p)
    {
        ...
        sb.AppendLine("using HighPop.Games;");
        sb.AppendLine("using HighPop.Models;");
        sb.AppendLine();
        sb.AppendLine($"// Auto-exported from HighPop — edit as needed, then import with \"⬆ Import .cs plugin\"");
        sb.AppendLine();
