...
public class TrayService : IDisposable
{
    ...
    private void Initialize()
    {
        ...
        {
            Text    = "HighPop Rust Manager",
            Visible = true,
            Icon    = CreateIcon(),
        };

        var menu = new ContextMenuStrip();
        menu.Items.Add("Open HighPop", null,    (_, _) => ShowWindowRequested?.Invoke());
    ...
    {
        if (_tray != null)
            _tray.Text = $"HighPop — {running}/{total} servers running";
    }
    ...
    private static Icon CreateIcon()
    {
        try
        {
            var sri = System.Windows.Application.GetResourceStream(
                new Uri("pack://application:,,,/HighPop;component/assets/brand/highpop.ico"));
