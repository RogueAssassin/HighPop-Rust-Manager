...
public partial class App : System.Windows.Application
{
    ...
    // Kept alive for the app's lifetime — running two HighPop instances at once leads to port
    ...
    {
        _singleInstanceMutex = new System.Threading.Mutex(true, "HighPop_Rust_Manager_SingleInstance", out var createdNew);
        if (!createdNew)
        {
            System.Windows.MessageBox.Show(
                "HighPop Rust Manager is already running. Check your system tray.",
                "HighPop already running",
        ...
        var logPath = System.IO.Path.Combine(exeDir, "assets", "logs", "crash.log");
        ...
        DispatcherUnhandledException += (_, ex) =>
        {
            ...
            System.Windows.MessageBox.Show(
                ...
                "HighPop — Error", System.Windows.MessageBoxButton.OK,
        ...
        {
            try { webApi.Start(config.WebApiPort, config.WebApiToken); }
            catch (Exception ex)
            {
                WriteLog($"WEB API: {ex}");
                System.Windows.MessageBox.Show(
                    $"Remote access could not start: {ex.Message}\n\nHighPop will continue with remote access disabled.",
                    "HighPop — Remote access", System.Windows.MessageBoxButton.OK,
                    System.Windows.MessageBoxImage.Warning);
            }
        }
